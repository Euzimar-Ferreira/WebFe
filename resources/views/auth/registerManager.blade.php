...
@section('main')
    ...
    <center>
        <!-- Import logo -->
        <div class="orange accent-3" style="min-height:260px">
            <br/>
            <div style="width:125px;height:68px;background-image:url('img/logo.png');background-size:100%">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col l6 m6 offset-l3 offset-m3 white" style="margin-top:-150px; padding-left:60px;padding-right:60px;padding-bottom:30px">
                ...
                <div class="row">
                    <!-- Título do Card -->
                    <span class="card-title orange-text text-darken-4" style="font-size:20px">
                    ...
                    <form id="frmCadastro" action="{{ route('registrarManager') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-field col l5 s12">
                            ...
                            <a href="#!"  class="datepicker ">
                                <i class="material-icons right orange darken-3 white-text hoverable" style="padding-left:10px;padding-right:10px;margin-top:-40px;padding-top:3px;padding-bottom:3px">today</i>
                            </a>
