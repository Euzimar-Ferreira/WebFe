@extends('website.templates.page')
...
@section('main')
    ...
    <center> 
        ...
        <a href="{{route('Cadastrar-Usuario.index')}}" class="waves-effect waves-teal btn grey lighten-1 green-text text-darken-4 z-depth-0" style="width:50%">Cadastre-se AQUI</a>
    </center>
    @endsection